                ...
                <form action="/ads/create" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description"
                                  class="form-control">${sessionScope.oldInput.description == null ? "": sessionScope.oldInput.description}</textarea>
                    </div>

                    <div class="form-group">
                        <c:forEach var="category" items="${categories}">
                            <input class="categories_text" type="checkbox" name="category"
